...
- [ ] playit: Iniciar túnel genera claim_url al instante, abrir el enlace nada más verlo, la vinculación arranca sola (~20s) o con Confirmar vinculación, aprobar en navegador, dirección pública aparece (sola vía `status`, o Escríbela desde el dashboard), crear Tunnel en dashboard apunta al puerto. Si no aparece sola: Ajustes → Diagnóstico y pegar la salida. Tras actualizar desde ≤0.16: borrar install.log, Desvincular y reclamar (el secreto viejo pudo filtrarse al log).
